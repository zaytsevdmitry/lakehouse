...
@RestController
public class ScheduleInstanceDAGController {
    private final ScheduleInstanceDAGService scheduleInstanceDAGService;

    public ScheduleInstanceDAGController(ScheduleInstanceDAGService scheduleInstanceDAGService) {
        this.scheduleInstanceDAGService = scheduleInstanceDAGService;
    }
