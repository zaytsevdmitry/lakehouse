...
load_image_if_missing "lakehouse:0.6.0"
load_image_if_missing "lakehouse-s3-check:0.6.0"
load_image_if_missing "lakehouse-hms:0.6.0"
load_image_if_missing "lakehouse-spark-aws:0.6.0"
load_image_if_missing "lakehouse-task-proxy4spark:0.6.0"
