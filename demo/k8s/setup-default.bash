...
#helm uninstall my-spark-operator spark-operator/spark-operator
helm install my-spark-operator spark-operator/spark-operator \
--set webhook.enable=true
kubectl get pods -n lakehouse-management | grep spark-operator
kubectl apply -f task-executor-svc-rbac.yaml
