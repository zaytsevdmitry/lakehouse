...
|--------------|-------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|----------------|
|k8s.spark-native.appResource| Путь к jar  в котором находится mainClass.                              | "local:///opt/lakehouse-task-spark-apps/lakehouse-task-executor-spark-dataset-app-0.4.0-jar-with-dependencies.jar" | spark-internal |
...
```json
{
  ...
  "service":
  {
    ...
    "properties": {
      ...
      "spark.kubernetes.container.image": "lakehouse-spark-aws:0.4.0",
...
```json
 {
  ...
  "spec" : {
    "containers" : [ {
      ...
      "image" : "lakehouse-spark-aws:0.4.0",
      "name" : "spark-driver",
      "resources" : {
        "limits" : {
          "cpu" : "1",
