...
public class SuccessTaskProcessor extends AbstractTaskProcessor{
    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    private final StateRestClientApi stateRestClientApi;
    public SuccessTaskProcessor(
    ...
    public Status.Task runTask() {
        DataSetStateDTO dataSetStateDTO = DataSetStateDTOFactory.buildtDataSetStateDTO(Status.DataSet.SUCCESS,getTaskProcessorConfig());
