...
public class FileLoader {
    ...
    public TaskExecutionServiceGroupDTO loadTaskExecutionServiceGroupDTO() throws IOException {
        return objectMapper.readValue(new File(".demo/taskexecutionservicegroups/default.json"), TaskExecutionServiceGroupDTO.class);
    }

    public DataStoreDTO loadDataStoreDTO(String name) throws IOException {
        return objectMapper
                .readValue(
                        new File(String.format(".demo/datastores/%s.json", name)),
                        DataStoreDTO.class);
    }

    public ScenarioActTemplateDTO loadScenarioDTO() throws IOException {
        return objectMapper.readValue(new File(".demo/scenario-act-templates/default.json"), ScenarioActTemplateDTO.class);
    }
