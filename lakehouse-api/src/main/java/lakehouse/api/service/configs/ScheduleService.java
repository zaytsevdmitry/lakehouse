...
public class ScheduleService {
	...
	public ScheduleService(ScheduleRepository scheduleRepository, DataSetRepository dataSetRepository,
			ScenarioActTemplateRepository scenarioActTemplateRepository, ScenarioActRepository scenarioActRepository,
	...
	public ScheduleDTO save(ScheduleDTO scheduleDTO) {
		...
		scheduleDTO.getScenarioActs().stream()
