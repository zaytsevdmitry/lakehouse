...
import lakehouse.api.exception.DataStoreNotFoundException;
import lakehouse.api.repository.configs.DataStorePropertyRepository;
import lakehouse.api.repository.configs.DataStoreRepository;
...
public class DataStoreService {
    ...
    public DataStoreService(DataStoreRepository dataStoreRepository, DataStorePropertyRepository dataStorePropertyRepository) {
    ...
    private DataStore findByName(String name) {
        return dataStoreRepository
                ...
                .orElseThrow(() -> {
                    ...
                    return new RuntimeException("Can't get name");
                });
    }
    ...
    public DataStoreDTO findById(String name) {
        return mapDataStoreToDTO(dataStoreRepository.findById(name).orElseThrow(() -> new DataStoreNotFoundException(name)));
    }
