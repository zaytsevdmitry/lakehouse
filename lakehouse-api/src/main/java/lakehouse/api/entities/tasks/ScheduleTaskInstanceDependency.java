...
@Table(uniqueConstraints = @UniqueConstraint(
        name = "schedule_task_instance_dependency_schedule_task_instance_id_depends_id_uk",
        columnNames = {"schedule_task_instance_id", "depends_id"}))
public class ScheduleTaskInstanceDependency {
    ...
    public boolean equals(Object o) {
        ...
        return isSatisfied() == that.isSatisfied() && Objects.equals(getId(), that.getId()) && Objects.equals(getScheduleTaskInstance(), that.getScheduleTaskInstance()) && Objects.equals(getDepends(), that.getDepends());
    }
