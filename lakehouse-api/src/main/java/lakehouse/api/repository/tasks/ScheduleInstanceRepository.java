...
public interface ScheduleInstanceRepository extends JpaRepository<ScheduleInstance, Long> {
    ...
    Optional<ScheduleInstance> findByScheduleNameAndTargetDateTime(String scheduleName, OffsetDateTime targetExecutionDateTime);
    ...
    List<ScheduleInstance> findByScheduleNameNotSuccessOrderByTargetExecutionDateTimeAsc(String scheduleName, Limit limit);
}
