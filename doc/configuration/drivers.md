...
| connectionTemplates                  | Содержит список возможных шаблонов образования строки подключения. Поддерживаются ключи spark, jdbc           |
| sqlTemplate                       | Реализует адоптацию диалекта.                                                                                 |
