...
public abstract class ExecuteUtilsAbstract implements ExecuteUtils {
    ...
    public ExecuteUtilsAbstract(JinJavaUtils jinJavaUtils, DataSourceDTO dataSourceDTO) {
    ...
    public String getConnectionString() throws TaskConfigurationException {
        ...
        ServiceDTO serviceDTO = dataSourceDTO.getService();
        return dataSourceDTO.getDatabaseProtocol().buildConnectionStringTemplate(serviceDTO.getHost(), Integer.parseInt(serviceDTO.getPort()), serviceDTO.getUrn());
    }
