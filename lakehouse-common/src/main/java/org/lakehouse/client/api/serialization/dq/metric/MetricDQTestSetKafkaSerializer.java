...
public class MetricDQTestSetKafkaSerializer implements Serializer<MetricDQStatusTestSetDTO> {
    private final ObjectMapper objectMapper = new ObjectMapper();
    final private Logger logger = LoggerFactory.getLogger(this.getClass());

    @Override
    public byte[] serialize(String topic, MetricDQStatusTestSetDTO data) {
        try {
            if (data == null) {
