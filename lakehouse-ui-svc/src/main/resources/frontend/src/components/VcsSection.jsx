...
function VcsLogPanel() {
  ...
  const split = useResizableSplit({
    containerRef,
    axis: 'vertical',
    minPercent: LOG_TOP_MIN_PERCENT,
    maxPercent: LOG_TOP_MAX_PERCENT,
    defaultPercent: LOG_TOP_DEFAULT_PERCENT,
  });

  const topPercent = split.percent;
  ...
  return (
    <div className="vcs-panel">
      ...
      <div className="vcs-log-layout" ref={containerRef}>
        ...
        <div className="catalog-splitter" onMouseDown={split.startDrag} />
