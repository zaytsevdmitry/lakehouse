...
public class TaskLockObjectActionsImpl implements TaskLockObjectActions{
	...
	public TaskLockObjectActionsImpl(ConfigRestClientApi configRestClientApi) {
		this.configRestClientApi = configRestClientApi;
	}
	@Override
	public CommandResult showOne(String[] args)  {
		return ObjectActionsHelper.getObjectJSONResult( configRestClientApi.getScheduledTaskLockDTO(args[3]));
	}

	@Override
	public CommandResult showAll(String[] args) {
		List<ScheduledTaskLockDTO> l = configRestClientApi.getScheduledTaskLockDTOList();
	...
	public CommandResult lockNew(String[] args) {
		return ObjectActionsHelper.getObjectJSONResult( configRestClientApi.lockTask(args[2],args[3]));
	}
	@Override
	public CommandResult lockHeartBeat(String[] args) {
		...
		return ObjectActionsHelper.coverHttpCode(configRestClientApi.lockHeartBeat(h));
	...
	public CommandResult lockRelease(String[] args) {
		...
		return ObjectActionsHelper.coverHttpCode(configRestClientApi.lockRelease(r));
	}
}
