 ...
 * ({@code lakehouse.configurator.vcs-system-account}), installing the Apache SSH session
...
public final class GitCredentials {
    ...
    public static CredentialsProvider forSystemAccount(ConfiguratorProperties.SystemAccount account) {
