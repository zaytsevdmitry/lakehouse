...
public class GitLabApiVcsProvider implements VcsProvider {
    ...
    public GitLabApiVcsProvider(ConfiguratorProperties properties, CredentialsProvider credentials) {
    ...
    public VcsReviewResult submitReview(VcsReviewSubmission submission, UserContext user) {
        ...
        client.commit(
                submission.branch(),
                submission.commitMessage() == null ? "Configurator update" : submission.commitMessage(),
