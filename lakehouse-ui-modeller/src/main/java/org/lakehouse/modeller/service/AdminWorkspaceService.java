...
public class AdminWorkspaceService {
    ...
    public AdminWorkspaceService(WorkspaceManager manager, UserContextService users, SyncLogService logs) {
    ...
    public List<WorkspaceResponse> listAll(Authentication authentication) {
        users.requireAdmin(authentication);
    ...
    public void delete(String workspaceId, Authentication authentication) {
        UserContext user = users.requireAdmin(authentication);
