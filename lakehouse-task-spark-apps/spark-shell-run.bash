...
--conf "spark.sql.extensions"="org.apache.iceberg.spark.extensions.IcebergSparkSessionExtensions" \
--conf "spark.sql.catalog.lakehousestorage"="org.apache.iceberg.spark.SparkCatalog" \
--conf "spark.sql.catalog.lakehousestorage.type"="hive" \
--conf "spark.sql.catalog.lakehousestorage.uri"="thrift://localhost:9083" \
...
--conf "spark.sql.catalog.processingdb"="org.apache.spark.sql.execution.datasources.v2.jdbc.JDBCTableCatalog" \
--conf "spark.sql.catalog.processingdb.user"="postgresUser" \
--conf "spark.sql.catalog.processingdb.password"="postgresPW" \
--conf "spark.sql.catalog.processingdb.type"="hive" \
--conf "spark.sql.catalog.processingdb.url"="jdbc:postgresql://localhost:5432/postgresDB"

--conf "spark.sql.catalog.processingdb.url": "{{driver.connectionTemplates['jdbc']}}"

spark-shell --master local \
--conf "spark.sql.catalog.processingdb"="org.apache.spark.sql.execution.datasources.v2.jdbc.JDBCTableCatalog" \
--conf "spark.sql.catalog.processingdb.user"="postgresUser" \
--conf "spark.sql.catalog.processingdb.password"="postgresUser" \
--conf "spark.sql.catalog.processingdb.type"="hive" \
--conf "spark.sql.catalog.processingdb.url"="jdbc:postgresql://localhost:5432/postgresDB"
