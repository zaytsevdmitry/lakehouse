...
public  class SparkProcessorBodyFactory {
    ...
    public static SparkProcessorBody buildSparkProcessorBody(
        ...
        if ( SparkProcessorBodyAbstract.class.isAssignableFrom(processorBodyClass)) {
            ...
            try {
                constructor = processorBodyClass.getConstructor(SparkSession.class,TaskProcessorConfigDTO.class);
            ...
            try {
                result = (SparkProcessorBody) constructor.newInstance(sparkSession, taskProcessorConfigDTO);
