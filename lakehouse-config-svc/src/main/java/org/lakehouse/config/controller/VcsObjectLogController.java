...
/**
 * Read-only access to the per-object VCS synchronization log.
 */
@RestController
@Tag(name = "VCS object log")
public class VcsObjectLogController {

    private final VcsObjectLogService vcsObjectLogService;

    public VcsObjectLogController(VcsObjectLogService vcsObjectLogService) {
        this.vcsObjectLogService = vcsObjectLogService;
    }
