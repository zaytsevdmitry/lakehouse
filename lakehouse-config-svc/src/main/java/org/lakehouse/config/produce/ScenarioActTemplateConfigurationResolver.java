...
@Component
public class ScenarioActTemplateConfigurationResolver implements ConfigurationProduceResolver {

    public static final String KIND = "ScenarioActTemplate";

    private final ScenarioActTemplateService scenarioActTemplateService;

    public ScenarioActTemplateConfigurationResolver(ScenarioActTemplateService scenarioActTemplateService) {
    ...
    @Override
    public ScenarioActTemplateDTO resolve(String keyName) {
