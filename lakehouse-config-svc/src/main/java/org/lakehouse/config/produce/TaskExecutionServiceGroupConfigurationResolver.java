...
@Component
public class TaskExecutionServiceGroupConfigurationResolver implements ConfigurationProduceResolver {

    public static final String KIND = "TaskExecutionServiceGroup";

    private final TaskExecutionServiceGroupService taskExecutionServiceGroupService;

    public TaskExecutionServiceGroupConfigurationResolver(
    ...
    @Override
    public TaskExecutionServiceGroupDTO resolve(String keyName) {
