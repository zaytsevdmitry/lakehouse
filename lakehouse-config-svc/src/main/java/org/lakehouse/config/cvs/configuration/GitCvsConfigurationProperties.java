...
/**
 * Configuration of the Git configuration repository used by the CVS subsystem.
 * <p>
 * Prefix: {@code lakehouse.config.cvs}
 */
@Component
@ConfigurationProperties(prefix = "lakehouse.config.cvs")
public class GitCvsConfigurationProperties extends ConfigurationPropertiesAbstract {
