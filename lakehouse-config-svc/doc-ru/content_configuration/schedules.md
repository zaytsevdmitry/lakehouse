...
| intervalExpression     | Выражение задания периодичности расписания (например @daily)                                             |
...
Список объектов в сокращенном виде (заголовки расписаний)

##  /v1_0/configs/schedules/{keyName}
Манипуляция конкретным объектом по ключу

##  /v1_0/configs/effective/schedules/fromdt/{dt}
Вернет настройки расписаний, измененные начиная с указанного момента времени {dt}
